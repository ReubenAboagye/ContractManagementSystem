...
namespace ContractManagementSystem
{
    ...
    {
        readonly string server = "localhost";//"db4free.net";
        readonly int port = 3306;
        string username = "root";//"gaayan23";
        string password = "!Won2Develop?";//"123Gaayan45?";
        readonly string database = "gaayanenterprise";//"gaayanenterprise";
        ...
        private void RegisterNewUser(string usern, string pass, string userRole)
        {
            try
            {
                ...
                dbConnection.InsertNewUser(usern, salt, hashedPassword, userRole);
        ...
        private void Register_Button_Click(object sender, EventArgs e)
        {
            ...
            string userRole = Role_ComboBox.Text;
            ...
            RegisterNewUser(username, password,userRole);
        }
    }
}
